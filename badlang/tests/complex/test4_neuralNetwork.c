...
int hidden0(int i0, int i1, int i2, int i3) {
    int w0 = 2; int w1 = -1; int w2 = 3; int w3 = 1;
    int sum = i0 * w0 + i1 * w1 + i2 * w2 + i3 * w3;
    return relu(sum);
}

int hidden1(int i0, int i1, int i2, int i3) {
    int w0 = -2; int w1 = 3; int w2 = 1; int w3 = 0;
    int sum = i0 * w0 + i1 * w1 + i2 * w2 + i3 * w3;
    return relu(sum);
}

int hidden2(int i0, int i1, int i2, int i3) {
...
int output0(int h0, int h1, int h2) {
    int w0 = 1; int w1 = -2; int w2 = 3;
    int sum = h0 * w0 + h1 * w1 + h2 * w2;
    return sum;
}

int output1(int h0, int h1, int h2) {
...
// Forward pass
int forward(int i0, int i1, int i2, int i3) {
